package me.jordanzimmitti.recyclerview
...
/** Kotlin Class RecyclerAdapter
 *
 * Class That Creates An Adapter To Show All The Items In A List For A Given Type
 *
...
class JZRecyclerAdapter<TYPE>(private val layoutId: Int,
    ...
    companion object {
        ...
        fun whenScrolling(recyclerView: RecyclerView, scroll: Scroll) {
            ...
            // Sets The Value For this.scroll//
            this.scroll = scroll
        ...
        /**.
         * Function That Handles When The RecyclerAdapter Is Multi Selected
         *
        ...
        fun multiSelected(recyclerAdapter: JZRecyclerAdapter<*>, multiSelect: MultiSelect) {
            ...
            // Sets The Value For this.multiSelect//
        ...
        /**.
         * Function That Handles The OnScrollListener
         *
         * @param recyclerView Any recycler view
         */
        ...
        /**.
         * Function That Handles The OnMultiChoiceSelectionListener
         *
         * @param recyclerAdapter Any recycler adapter
         */
    ...
    override fun defaultItemViewClickListener(holder: ViewHolder?, position: Int): View.OnClickListener? {
        ...
        return View.OnClickListener { view ->
            ...
            // Differ Action To Another Class Instance//
    ...
    override fun onBindViewHolder(holder: JZRecyclerAdapter<TYPE>.ViewHolder, position: Int) {
        ...
        // Differ To Parent Class//
        super.onBindViewHolder(holder, position)

        // Set The Item To Its Corresponding View//
        holder.itemView.views(list[position])
    }

    /**.
     * Function That Sets The Value For When An Item is Clicked
     *
     * @param itemClick Action from the caller class
     */
    fun setItemClick(itemClick: ItemClicked) {

        // Sets The Value For this.itemClick//
    ...
    class Spacing(private val height: Int): RecyclerView.ItemDecoration() {
        ...
        override fun getItemOffsets(spacing: Rect, view: View, parent: RecyclerView, c: RecyclerView.State) {
            ...
            // Set The Spacing For The Last Item//
